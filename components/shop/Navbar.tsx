...
const YT =
  ...
  "https://www.youtube.com/@JindalVastrakala";
const BROADCAST_MSG = encodeURIComponent(
  "Hi! I'd like to join your WhatsApp broadcast list and be the first to know about new arrivals and exclusive pieces from Jindal Vastrakala."
);
  ...
  return (
    <>
      ...
      >
        ...
        {menuOpen && (
          <div
            className="lg:hidden px-6 py-4 flex flex-col gap-1 gold-border-top"
